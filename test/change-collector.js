    ...
    'in_msgs': [
        {
            ...
            "body": [
                ...
                "uint8", 7, // change collector
                "Address", "-1:77dfd552e63729b472fcbcc8c45ebcc6691702558b68ec7527e1ba403a0f31a8"
            ],
            "new_data": [
                "uint8", 0, // state_flags
                "coins", 0, // total_locked
                "uint3", 4, // collector_address, prefix
                "int8", -1, // collector_address, wc
                "uint256", "0x77dfd552e63729b472fcbcc8c45ebcc6691702558b68ec7527e1ba403a0f31a8", // collector_address
                "coins", 2*1e9, // flat_reward
                "coins", 3*1e9, // network_fee
                "uint14", 0, // factor
            ],
